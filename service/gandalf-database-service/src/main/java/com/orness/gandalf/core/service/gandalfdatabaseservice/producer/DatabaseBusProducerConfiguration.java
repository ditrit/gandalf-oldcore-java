...
public class DatabaseBusProducerConfiguration {
    ...
    @Bean
    public ProducerFactory<String, GandalfMessage> databaseMessageKafkaProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, GandalfMessage> databaseMessageKafkaTemplate() { return new KafkaTemplate<>(databaseMessageKafkaProducerFactory());
    }
}
