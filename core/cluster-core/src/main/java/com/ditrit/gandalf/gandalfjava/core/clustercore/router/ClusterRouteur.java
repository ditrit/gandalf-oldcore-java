package com.ditrit.gandalf.gandalfjava.core.clustercore.router;

import com.ditrit.gandalf.gandalfjava.core.zeromqcore.command.router.ClusterCommandRouter;
...
public class ClusterRouteur extends ClusterCommandRouter {
    ...
    public ZMsg getCommandTarget(ZMsg command) {
        ...
        String target = this.restTemplate.getForObject(ClusterConstant.CLUSTER_ROUTER_URL + "/" + commandArray[8] + "/" + commandArray[14] + "/" + commandArray[15], String.class);
