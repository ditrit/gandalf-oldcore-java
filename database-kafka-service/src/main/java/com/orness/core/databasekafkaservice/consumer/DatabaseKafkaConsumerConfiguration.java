...
@EnableKafka
@Configuration
public class DatabaseKafkaConsumerConfiguration {

    public ConsumerFactory<String, MessageKafka> databaseMessageKafkaConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageKafka> databaseMessageKafkaListenerContainerFactory() {
