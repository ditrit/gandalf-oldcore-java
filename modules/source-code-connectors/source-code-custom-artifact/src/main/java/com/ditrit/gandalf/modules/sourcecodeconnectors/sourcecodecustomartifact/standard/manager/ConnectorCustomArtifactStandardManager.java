package com.ditrit.gandalf.modules.sourcecodeconnectors.sourcecodecustomartifact.standard.manager;
...
public class ConnectorCustomArtifactStandardManager extends ConnectorArtifactStandardManager {

    private final Path fileStorageLocation;
    private Gson mapper;

    @Autowired
    public ConnectorCustomArtifactStandardManager() {
        super();
