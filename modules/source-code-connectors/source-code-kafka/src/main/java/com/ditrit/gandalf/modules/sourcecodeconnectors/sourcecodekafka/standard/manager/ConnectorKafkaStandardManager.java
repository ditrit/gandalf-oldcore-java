package com.ditrit.gandalf.modules.sourcecodeconnectors.sourcecodekafka.standard.manager;

import com.ditrit.gandalf.modules.sourcecodeconnectors.sourcecodekafka.core.consumer.ConnectorKafkaConsumer;
import com.ditrit.gandalf.modules.sourcecodeconnectors.sourcecodekafka.core.producer.ConnectorKafkaProducer;
import com.ditrit.gandalf.modules.sourcecodeconnectors.sourcecodekafka.properties.ConnectorKafkaProperties;
import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.ditrit.gandalf.modules.abstractconnectors.abstractbus.manager.ConnectorBusStandardManager;
...
public class ConnectorKafkaStandardManager extends ConnectorBusStandardManager {
    ...
    @Autowired
    public ConnectorKafkaStandardManager(KafkaAdmin kafkaAdmin, ConnectorKafkaConsumer connectorKafkaConsumer, ConnectorKafkaProducer connectorKafkaProducer) {
