...
public class ConnectorGitlabNormativeWorker extends RunnableWorkerZeroMQ {
    ...
    public ConnectorGitlabNormativeWorker(ConnectorGitlabProperties connectorGitlabProperties, ConnectorGitlabNormativeManager connectorGitlabNormativeManager) {
        ...
        this.initRunnable(WORKER_SERVICE_CLASS_NORMATIVE, this.connectorGitlabProperties.getConnectorCommandBackEndSendConnection(), this.connectorGitlabProperties.getConnectorCommandBackEndReceiveConnection(), this.connectorGitlabProperties.getConnectorEventBackEndSendConnection(), this.connectorGitlabProperties.getConnectorEventBackEndReceiveConnection(), null);
    }
//TODO PAYLOAD
    @Override
