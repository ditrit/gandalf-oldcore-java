...
@Component
public class ConnectorGitStandardManager extends ConnectorVersionControlStandardManager {

    private ConnectorGitService connectorGitService;

    @Autowired
    public ConnectorGitStandardManager(ConnectorGitService connectorGitService) {
