...
@EnableKafka
@Configuration
public class ConnectorKafkaConsumerConfiguration {

    public ConsumerFactory<String, MessageKafka> connectorMessageKafkaConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageKafka> connectorMessageKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MessageKafka> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(connectorMessageKafkaConsumerFactory());
        return factory;
    }
}
