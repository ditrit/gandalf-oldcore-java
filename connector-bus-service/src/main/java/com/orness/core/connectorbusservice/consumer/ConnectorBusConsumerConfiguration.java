...
@EnableKafka
@Configuration
public class ConnectorBusConsumerConfiguration {

    public ConsumerFactory<String, MessageBus> connectorMessageKafkaConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageBus> connectorMessageKafkaListenerContainerFactory() {
