...
public class ConnectorKafkaNormativeRoutingRoutingWorker extends RunnableRoutingRoutingWorkerZeroMQ {

    private ConnectorKafkaNormativeManager kafkaCommonManager;
    private KafkaProperties kafkaProperties;

    @Autowired
    public ConnectorKafkaNormativeRoutingRoutingWorker(ConnectorKafkaNormativeManager kafkaCommonManager, KafkaProperties kafkaProperties) {
        super();
