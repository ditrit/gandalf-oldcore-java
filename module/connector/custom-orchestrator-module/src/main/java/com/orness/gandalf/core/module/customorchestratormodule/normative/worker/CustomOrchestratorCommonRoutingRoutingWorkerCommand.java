...
public class CustomOrchestratorCommonRoutingRoutingWorkerCommand extends RunnableRoutingRoutingWorkerZeroMQ {
    ...
    @Autowired
    public CustomOrchestratorCommonRoutingRoutingWorkerCommand(CustomOrchestratorCommonManager customOrchestratorCommonManager, CustomOrchestratorProperties customOrchestratorProperties) {
        super();
