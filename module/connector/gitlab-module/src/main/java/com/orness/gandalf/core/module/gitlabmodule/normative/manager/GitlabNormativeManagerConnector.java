...
import com.orness.gandalf.core.module.gitmodule.config.normative.manager.GitNormativeManagerConnector;
...
@Component
public class GitlabNormativeManagerConnector extends ConnectorVersionControlNormativeManager {

    private GitLabApi gitLabApi;
    private GitNormativeManagerConnector gitCommonManager;

    public GitNormativeManagerConnector getGitCommonManager() {
        return gitCommonManager;
    }

    @Autowired
    public GitlabNormativeManagerConnector(GitLabApi gitLabApi, GitNormativeManagerConnector gitCommonManager) {
