...
@Component
public class GandalfRoutingRoutingWorkerCommand extends RunnableRoutingRoutingWorkerZeroMQ {

    private GandalfConnectorManager gandalfConnectorManager;
    private GandalfProperties gandalfProperties;

    @Autowired
    public GandalfRoutingRoutingWorkerCommand(GandalfConnectorManager gandalfConnectorManager, GandalfProperties gandalfProperties) {
        super();
