...
public class GandalfBrokerBean implements Runnable {
    ...
    @Override
    public void run() {
        new Broker(gandalfProperties.getClientBackEndConnection2(), gandalfProperties.getWorkerFrontEndConnection2(), gandalfProperties.getCaptureBackEndConnection2());
    }
}
